...
class CausalForestConfig(BaseModel):
    ...
    CFT optimiert Forest-Parameter (n_estimators, max_depth, etc.) für
    CausalForestDML und CausalForest. n_estimators wird auf Vielfache von
    subforest_size=4 beschränkt. Bei RCT wird model_t als DummyClassifier
