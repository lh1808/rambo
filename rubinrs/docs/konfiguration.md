...
- `overfit_penalty`: Train-Val-Gap-Penalty für model_final (0=deaktiviert). Bestraft Konfigurationen, deren Score (-MSE) auf Train deutlich besser ist als auf Val (OOF). Formel: `adjusted = val_score - penalty × max(0, gap - tolerance)`.
