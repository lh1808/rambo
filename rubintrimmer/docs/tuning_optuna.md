...
Wenn `tuning_seed == SEED`, loggt die Pipeline eine Warnung. Die Web-UI zeigt einen gelben Hinweis. In diesem Fall sind die Tuning- und CP-Folds identisch und der Schutz ist deaktiviert.
