...
const YAML_TO_CFG = {
  ...
  "shap_values.calculate_shap_values":"explEnabled","shap_values.n_shap_values":"explSampleSize","shap_values.top_n_features":"explTopN","shap_values.num_bins":"shapBins","shap_values.shap_calculation_models":"shapModels",
  ...
  return (
    <>
      ...
      {view==="files"&&<>
        ...
        {cfg.validateOn==="external" && <Sec title="2. Externe Evaluation" accent="#6366f1">
        ...
        {cfg.s_file && <Sec title={cfg.validateOn==="external" ? "3. Benchmark (optional)" : "2. Benchmark (optional)"}>
      ...
      {view==="files"&&<Sec title={`${(cfg.validateOn==="external"?3:2)+(cfg.s_file?1:0)}. Datenqualität`}>
