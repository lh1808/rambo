...
class DataProcessingConfig(BaseModel):
    ...
    # EconML-Default=2 (50% Daten pro Nuisance-Fit), 5 liefert stabilere Residuals.
    dml_crossfit_folds: int = 5  # Wird zur Laufzeit auf cross_validation_splits gesetzt
...
class AnalysisConfig(BaseModel):
    ...
    study_type: str = "rct"  # "rct" | "observational"
    class_balance: bool = False  # Auto-Balancing für stark imbalancierte Zielvariable
        ...
        if self.treatment.type == "multi":
            ...
            if self.selection.metric in _bt_only_metrics:
                raise ValueError(
                    ...
                    f"Empfohlen: 'policy_value', 'policy_value_T1', "
