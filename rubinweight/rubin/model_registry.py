...
class ModelContext:
    ...
    # Class-Balancing für stark imbalancierte Zielvariable
...
erzeugt."""
    ...
    def _base(ctx: ModelContext, role: str):
        ...
        return build_base_learner(ctx.base_learner_type, params, seed=ctx.seed, task=task, parallel_jobs=ctx.parallel_jobs, class_balance=ctx.class_balance)
