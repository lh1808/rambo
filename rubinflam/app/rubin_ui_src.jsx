    ...
    <>
      ...
      <Sec title="5. Weitere Optionen">
        {(() => {
          ...
          <Inp label="Ausgabepfad" value={dp.outputPath||"data/processed"} onChange={v=>setDp(prev=>({...prev,outputPath:v}))} help="Zielordner für X/T/Y.parquet + Preprocessing-Artefakte"/>
...
const YAML_TO_CFG = {
  ...
  "tuning.per_role":"tuningPerRole","tuning.per_learner":"tuningPerLearner","tuning.timeout_seconds":"tuningTimeout","tuning.max_tuning_rows":"tuningMaxRows","tuning.automl":"tuningAutoml",
...
const PConfig = ({cfg,set}) => (<>
  ...
  <Sec title="Feature-Selektion" accent="#0891b2"> accent="#0891b2">
...
export default function App() {
  ...
  const [workDirInfo,setWorkDirInfo] = useState(null); // {work_dir, source, upload_dir, cache_dir, mlruns_dir}
