...
const YAML_TO_CFG = {
  ...
  "causal_forest.use_econml_tune":"cfTune","causal_forest.search_space":"_cfSS","causal_forest.depth_choices":"_cfDepthChoices","causal_forest.criterion_choices":"_cfCriterionChoices","causal_forest.n_trials":"cfTrials","causal_forest.single_fold":"cfSingleFold","causal_forest.tune_models":"cfTuneModels",
...
<div style={{fontSize:11,color:C.textSec,background:"#f9fafb",padding:"8px 12px",borderRadius:8,lineHeight:1.5,border:"1px solid #e5e7eb"}}>
  CausalForest-Tuning läuft <strong>sequentiell</strong> (CausalForestDML: Nuisance einmalig mit cache_values gecacht, Trials via setattr() + refit_final(). CausalForest: via CausalForestAdapter + RScorer). Alle CPU-Kerne pro Fit (n_jobs=-1). <strong style={{color:trialColor}}>{trials}</strong> Trials insgesamt.
  {trials < 15 && " TPE kann bei weniger als 15 Trials kaum zwischen guten und schlechten Parametern unterscheiden."}
  {trials >= 15 && trials < 30 && " Grenzwertig — TPE beginnt erst nach den Startup-Trials zu lernen."}
  {trials >= 30 && " Genug Trials für stabile TPE-Exploration und Exploitation."}
</div>
