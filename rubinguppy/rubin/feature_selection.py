...
def _catboost_gain_importance(
    ...
    try:
        from rubin.utils.gpu_utils import catboost_gpu_params, GPU_INCOMPATIBLE_PARAMS
        gpu_p = catboost_gpu_params()
    except ImportError:
        gpu_p = {}
        GPU_INCOMPATIBLE_PARAMS = set()
    ...
    cb_params.update(gpu_p)
    # GPU-inkompatible Parameter entfernen (z.B. rsm)
