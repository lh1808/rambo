...
für ein ausgewähltes Modell (SHAP-Importances)."""
...
def main() -> None:
    ...
    if not shap_available():
        raise RuntimeError(
            ...
            "Bitte 'shap' installieren (pip install shap)."
        )
    ...
    try:
        ...
        shap_result.shap_dependence.savefig(out_dir / f"SHAP_dependence_{model_name}.png", dpi=160, bbox_inches="tight")
        shap_result.shap_scatter.savefig(out_dir / f"SHAP_scatter_{model_name}.png", dpi=160, bbox_inches="tight")
        ...
        index.update({
            "summary": f"SHAP_summary_{model_name}.png",
            "cate_profiles": f"SHAP_cate_profiles_{model_name}.png",
            "dependence": f"SHAP_dependence_{model_name}.png",
            "scatter": f"SHAP_scatter_{model_name}.png",
