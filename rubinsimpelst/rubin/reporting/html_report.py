...
def generate_html_report(collector: ReportCollector, output_path: str) -> str:
    ...
    if cs.get("final_tuning_enabled"):
        ...
        h = '<p class="expl">Optimiert das CATE-Effektmodell (model_final) via Optuna mit cache_values: Nuisance-Modelle werden einmalig pro äußerem Fold gecacht, Trials fitten nur noch model_final via refit_final(). Bewertung per est.score() auf Out-of-Fold-Val. NonParamDML: R-Loss, DRLearner: DR-MSE. Higher=better.</p>'
