...
def generate_html_report(collector: ReportCollector, output_path: str) -> str:
    ...
    if ha:
        _sym = {"strong": "✓", "moderate": "◐", "weak": "△", "none": "✗",
        ...
        if h2:
            _sec("heterogeneity", "Heterogenität", h2)
    ...
    if cs.get("tuning_enabled") and collector.tuning_scores:
        ...
        if _op and _op > 0:
            ...
            h += f'<div class="cd"><div class="cd-l">Overfit-Penalty</div><div class="cd-v">{_op} (Tol. {_ot}{_cap_txt})</div></div>'
        h += '</div>'
    ...
    if cs.get("final_tuning_enabled"):
        ...
        if _fmt_op and _fmt_op > 0:
            ...
            h += f'<div class="cd"><div class="cd-l">Overfit-Penalty</div><div class="cd-v">{_fmt_op} (Tol. {cs.get("final_tuning_overfit_tolerance", 0.05)}{_fmt_cap_txt})</div></div>'
