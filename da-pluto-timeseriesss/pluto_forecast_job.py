...
def run_pluto_multivariate_forecast_job() -> Dict[int, Dict[str, object]]:
    ...
    try:
        ...
        # archivieren. Die Artefakte landen unter runs/<timestamp>_<horizont>/
        # und die globale Metriken-Historie wird fortgeschrieben.
        runs_dir = "runs"
        ...
        # Läufe gegen die jetzt vorliegenden Ist-Werte prüfen. Wächst mit
        # jedem Lauf, weil immer mehr Ist-Werte eingetroffen sind.
