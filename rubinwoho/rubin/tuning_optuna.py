...
class BaseLearnerTuner:
    ...
    def _role_signature(self, model_name: str, role: str) -> Tuple[str, str, bool, str, str]:
        ...
        - "all": Innerhalb von DML/DR-internem Cross-Fitting (cv=2) → sieht ~50% des äußeren Folds.
        ...
        if name == "xlearner":
            ...
            if role == "propensity_model":
                ...
                # während DML/DR-Propensity innerhalb von cv=2 trainiert wird (40% N).
                return ("propensity", "classifier", False, "all_direct", "T")

        # ── DRLearner ──
        # Nuisance-Modelle laufen innerhalb DRLearner cv=2 → scope="all" (40% N).
        if name == "drlearner":
        ...
        # Laufen innerhalb DML cv=2 → scope="all" (40% N).
