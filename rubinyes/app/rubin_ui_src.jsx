...
const pages = [
  ...
  {label:"Vorlage",key:"template",group:"Experiment"},
...
const YAML_TO_CFG = {
  "mlflow.experiment_name":"expName","constants.SEED":"seed","constants.parallel_level":"parallelLevel","constants.work_dir":"workDir",
...
const PData = ({cfg,set,setCfg,activeBase,setActiveBase,activeAddons,setActiveAddons,view}) => {
  ...
  return (
    <>
      ...
      {view==="template"&&<Sec title="2. Modell-Vorauswahl">
...
const PModels = ({cfg,set,sp,setSp,spFmt,setSpFmt}) => {
  ...
  return (<><Sec title="Kausale Modelle">{mt&&<Info type="warn"><strong>Multi-Treatment:</strong> Nur DML-Modelle verfügbar.</Info>}{cfg.hasNaN&&<Info type="warn"><strong>Fehlende Werte:</strong> CausalForestDML und CausalForest werden automatisch übersprungen (GRF-basierte Modelle können keine fehlenden Werte verarbeiten).</Info>}
    {[
            ...
            return (
              <button key={m} onClick={()=>{if(!ok)return;const s=new Set(cfg.models||[]);on?s.delete(m):s.add(m);set({...cfg,models:[...s]})}}
                ...
                <div>
                  ...
                  <div style={{fontSize:10.5,color:"#888",marginTop:2,lineHeight:1.4}}>{d}{!ok&&reason?` – ${reason}`:""}</div>
                </div>
              </button>
            );
          })}
...
export default function App() {
  ...
  const INIT_CFG = {expName:"rubin",seed:42,parallelLevel:3,workDir:null,x_file:"",t_file:"",y_file:"",s_file:"",treatmentType:"binary",refGroup:0,hasNaN:false,nanCols:[],validateOn:"cross",cvSplits:5,downsample:false,dfFrac:0.1,reduceMem:true,fsEnabled:false,fsMethods:["lgbm_importance"],fsTopPct:15,fsCorrThresh:0.9,outputDir:"",savePreds:false,predsFormat:"csv",models:["NonParamDML","DRLearner","SLearner","TLearner"],baseLearner:"catboost",tuningEnabled:true,tuningTrials:100,tuningSingleFold:false,tuningMetric:"log_loss",tuningMetricReg:"neg_mse",tuningPerRole:false,tuningPerLearner:false,tuningAutoml:"optuna",tuningModels:[],fmtEnabled:false,fmtModels:[],fmtSingleFold:false,fmtTrials:50,fmtMaxRows:0,cfTune:false,cfTuneIntensive:false,selMetric:"qini",higherBetter:true,refitChamp:true,manualChamp:null,surrEnabled:false,surrMinLeaf:50,surrLeaves:31,surrDepth:0,bundleEnabled:false,bundleDir:"runs/bundles",bundleChallengers:true,bundleMlflow:true,explEnabled:true,explMethod:"shap",explSampleSize:10000,explTopN:20,shapModels:[],shapBins:10,histScoreName:"historical_score",histScoreCol:"S",histScoreHigher:true,fsMaxFeatures:0,maxPredRows:0,tuningTimeout:0,tuningMaxRows:0,fmtTimeout:0,blFixed:{},fmtFixed:{},cfFixed:{},ensembleEnabled:false,mcIters:null,mcAgg:"mean",fmtStabilityPenalty:0};
