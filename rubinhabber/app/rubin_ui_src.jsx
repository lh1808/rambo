...
const CF_FOREST_DEFAULTS = {n_estimators:200,max_depth:null,min_samples_leaf:10,min_samples_split:20,max_features:"auto",max_samples:0.45,min_var_fraction_leaf:null,min_impurity_decrease:0.0,criterion:"mse"};

// CF Search Space Ranges (für RSlider-Editor)
const CF_SS = {
  n_estimators:         {min:50,  max:600, step:10,  type:"int"},
  max_depth:            {min:2,   max:30,  step:1,   type:"int"},
  min_samples_leaf:     {min:5,   max:500, step:5,   type:"int",  log:true},
  min_samples_split:    {min:10,  max:1000,step:10,  type:"int",  log:true},
  max_features:         {min:0.05,max:1.0, step:0.05,type:"float"},
  max_samples:          {min:0.1, max:1.0, step:0.05,type:"float"},
  min_var_fraction_leaf:{min:0.000001,max:0.1,step:0.0001,type:"float",log:true},
...
{(()=>{
  ...
  const g = k => ({low: cfSS[k]?.low ?? ({n_estimators:100,max_depth:3,min_samples_leaf:5,min_samples_split:10,max_features:0.1,max_samples:0.3,min_var_fraction_leaf:0.000001,min_impurity_decrease:0.0})[k], high: cfSS[k]?.high ?? ({n_estimators:500,max_depth:30,min_samples_leaf:200,min_samples_split:500,max_features:1.0,max_samples:0.9,min_var_fraction_leaf:0.05,min_impurity_decrease:0.01})[k]});
