...
const FinalTuningPlanPreview = ({models, fmtEnabled, fmtModels, fmtSingleFold, fmtTrials, fmtCv, outerCv: outerCvProp, mcIters, isBoth}) => {
  ...
  const internalCv = fmtCv || 2;  // FMT internes Nuisance-CV (Default=3)
...
function App() {
  ...
  const estimateFits = () => {
    ...
    const bltCv = cfg.dmlCrossfitFolds || 3;    // BLT innere CV
    const dmlCv = cfg.dmlCrossfitFolds || 2; // DML internes Cross-Fitting
    const fmtCv = cfg.dmlCrossfitFolds || 3;    // FMT internes CV
