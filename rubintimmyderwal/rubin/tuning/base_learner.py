...
class BaseLearnerTuner:
    ...
    def _apply_overfit_penalty(self, val_score: float, train_score: float,
        ...
        # Minimum-Scale 0.1: Verhindert, dass bei val_score ≈ 0 (z.B. R-Score
        # nahe Null) ein moderater absoluter Gap als riesiger relativer Gap
        # interpretiert wird (val=0.005, gap=0.005 → 100% statt 5%).
