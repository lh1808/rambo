...
</Col><Col><Toggle label="Single-Fold" checked={cfg.tuningSingleFold||false} onChange={v=>set({...cfg,tuningSingleFold:v})} help="1 Fold statt K pro Trial — bei K=5 also 5× schneller, aber verrauschtere Metrik."/></Col></Row>
</>);
})()}<Divider/>{_isBoth ? (<>
