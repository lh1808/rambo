...
class AnalysisPipeline:
    ...
    def _run_tuning(self, cfg, X, T, Y, mlflow, _progress_cb=None):
        ...
        if getattr(cfg, "final_model_tuning", None) is not None and cfg.final_model_tuning.enabled:
            ...
            mlflow.log_param("fmt__cv_splits", getattr(cfg.final_model_tuning, "cv_splits", 2))
            mlflow.log_param("fmt__method", getattr(cfg.final_model_tuning, "method", "rscorer"))
            mlflow.log_param("fmt__stability_penalty", getattr(cfg.final_model_tuning, "stability_penalty", 0.3))
            ...
            if hasattr(self, '_report'):
                ...
                try:
                    ...
                    fmt_internal_cv = getattr(cfg.final_model_tuning, "cv_splits", 2)
                    ...
                    self._report.add_fmt_info({
                        ...
                        "method": fmt_method,
                        "stability_penalty": getattr(cfg.final_model_tuning, "stability_penalty", 0.3),
