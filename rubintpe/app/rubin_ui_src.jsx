  ...
  return (
    <div>
      ...
      <div style={{fontSize:10.5,color:"#888",marginBottom:10,lineHeight:1.5}}>
        ...
        {isBoth && <span style={{display:"block",marginTop:6,color:"#7a5a00",background:"#fffbeb",padding:"4px 8px",borderRadius:6,border:"1px solid #e8d49c",fontSize:10.5}}><strong>CatBoost &amp; LGBM aktiv:</strong> Trials sind verdoppelt ({(trials||100)}T × 2 = {nTrials}T), damit beide Learner-Familien ausreichend Budget bekommen.</span>}
      </div>
