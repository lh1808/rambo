  ...
  return (
    <>
      {view==="files"&&<Sec title="Analysedaten">
        ...
        {/* ── External Eval ── */}
        <div style={{marginTop:20,background:cfg.validateOn==="external"?"#f0fdf4":"#fafafa",border:`1.5px solid ${cfg.validateOn==="external"?"#86efac":"#e5e5e5"}`,borderRadius:12,padding:"14px 18px",transition:"all 0.2s"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <span style={{fontSize:12,fontWeight:600,color:cfg.validateOn==="external"?"#166534":"#57606a",textTransform:"uppercase",letterSpacing:0.6}}>External Eval</span>
              {cfg.validateOn==="external" && (cfg.eval_x_file && cfg.eval_t_file && cfg.eval_y_file
                ? <span style={{fontSize:9,fontWeight:600,color:"#1a7f37",background:"#dcfce7",padding:"2px 8px",borderRadius:8}}>Bereit</span>
