  ...
  <>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:10,marginBottom:26}}>
      {[
        ...
        {v:"16+12",l:"Vorlagen & Add-ons",d:"16 Basis + 12 Add-ons",accent:"#6366f1"},
      ].map(c => (
    ...
    <>
      {view==="files"&&<Sec title="Analysedaten">
        ...
        <div style={{marginTop:20,borderTop:"1px solid "+C.borderLight,paddingTop:16}}>
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:cfg.validateOn==="external"?12:0,flexWrap:"wrap"}}>
            <div style={{fontSize:12,fontWeight:600,color:C.textSec,textTransform:"uppercase",letterSpacing:0.8}}>External Eval</div>
            <Toggle label="Aktivieren" checked={cfg.validateOn==="external"} onChange={v=>set({...cfg,validateOn:v?"external":"cross"})} help="Evaluation auf separatem Datensatz statt Cross-Validation"/>
