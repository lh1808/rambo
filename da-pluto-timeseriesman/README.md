...
Datengetrieben (typischerweise 10–50 Ausprägungen). Wird nicht im SQL
gefiltert, sondern vollständig geladen; NULL-Werte werden zu `UNBEKANNT`.

Im Code werden diese Dimensionen in einem Komponenten-Namen kombiniert, z. B.:

```text
TERM_EINGANG_SCHRIFTST__KFZ_Vollkasko__Neuschaden__ORG12
TERM_EINGANG_SONST__HUS_Hausrat__Folgebearbeitung__UNBEKANNT
```
