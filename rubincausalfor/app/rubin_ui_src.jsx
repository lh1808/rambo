...
const CF_SS = {
  ...
  max_samples:          {min:0.1, max:0.5, step:0.05,type:"float"},
...
{(()=>{
  ...
  const g = k => ({low: cfSS[k]?.low ?? ({n_estimators:100,max_depth:3,min_samples_leaf:5,min_samples_split:10,max_features:0.1,max_samples:0.15,min_var_fraction_leaf:0.000001,min_impurity_decrease:0.0})[k], high: cfSS[k]?.high ?? ({n_estimators:500,max_depth:30,min_samples_leaf:200,min_samples_split:500,max_features:1.0,max_samples:0.5,min_var_fraction_leaf:0.05,min_impurity_decrease:0.01})[k]});
