...
const PPreview = ({cfg,sp,spFmt,totalFits}) => {const y=buildYaml(cfg,sp,spFmt),issues=validate(cfg);const mt=cfg.treatmentType==="multi";return(<>
  <Row gap={10}>
    ...
    <MC value={(cfg.baseLearner||"catboost")==="both"?"Both":cfg.baseLearner==="lgbm"?"LGBM":"CatBoost"} label="Base-Learner"/>
    ...
    <MC value={(totalFits||0).toLocaleString("de-DE")} label="Fits" highlight/>
  </Row>
  <div style={{height:16}}/>
