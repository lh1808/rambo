    ...
    def tune(
        ...
        if _scorer_type == "qini":
            ...
            def objective(trial):
                ...
                if is_cfdml:
                    for fold_i, (est, tr, va) in enumerate(_cfdml_cached_folds):
                        try:
                            ...
                            all_y.append(Y_np[va])
                            all_t.append(T_np[va])
                ...
                curve = uplift_curve(y_agg.astype(int), t_agg.astype(int), cate)
            ...
            _cft_mode = "cache_values + refit_final" if is_cfdml else "CausalForestAdapter + OOF-Qini"
