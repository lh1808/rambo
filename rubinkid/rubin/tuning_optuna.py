...
class BaseLearnerTuner:
    ...
    def _tune_task_flaml(self, task: TuningTask, X: pd.DataFrame, Y: np.ndarray, T: np.ndarray,
        ...
        # MLflow-Autologging deaktivieren: FLAML triggert intern
        # sklearn/catboost-Autologging, das Parameter in den aktiven MLflow-Run
        # schreibt. Bei mehreren Tasks führt das zu "Changing param values is not
        # allowed"-Fehlern, weil der zweite Task andere Werte loggen will.
        # rubin macht sein eigenes explizites MLflow-Logging.
        try:
