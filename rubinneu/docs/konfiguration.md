...
Alternativ zu Optuna kann FLAML (Microsoft AutoML) für die HP-Suche verwendet werden (`automl: "flaml"`). FLAML übernimmt HP-Tuning + Early Stopping automatisch. Erfordert: `pip install flaml[automl]`. Falls FLAML nicht installiert ist, wird automatisch auf Optuna zurückgefallen.
