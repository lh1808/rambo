...
**FLAML** übernimmt HP-Suche + Early Stopping automatisch und wurde von Bach et al. (2024) und CausalTune als starke AutoML-Option für DML-Nuisance-Modelle validiert. Erfordert: `pip install flaml[automl]`. Falls FLAML nicht installiert ist, wird automatisch auf Optuna zurückgefallen.
...
Die Combined Loss wird in MLflow geloggt (`combined_loss__<ModelName>`) und im HTML-Report angezeigt. Deaktivierbar via:
