...
def generate_html_report(collector: ReportCollector, output_path: str) -> str:
    ...
    if cs.get("tuning_enabled") and collector.tuning_scores:
        ...
        if collector.combined_loss_diagnostic:
            ...
            h += '<p class="expl">Die Combined Loss ist das Produkt der Outcome- und Propensity-Fehler. Ein niedriger Wert korreliert mit besserer kausaler Schätzqualität (niedrigerer MSE auf dem kausalen Parameter, höhere Confidence-Interval-Coverage).</p>'
            h += '<div class="tbl-scroll"><table class="dt"><thead><tr><th>Modell</th><th>Combined Loss</th></tr></thead><tbody>'
