    ...
    <Sec title="Surrogate-Einzelbaum" accent="#D4A853">
      ...
      {cfg.surrEnabled&&<>
        ...
        <Row>
          ...
          <Col><Sld label="Max. Blätter" min={2} max={128} step={1} value={cfg.surrLeaves||31} onChange={v=>set({...cfg,surrLeaves:v})} help="Komplexität des Baums (wirkt bei LightGBM und CatBoost). 8–16 für einfache Regeln, 31+ für mehr Detail."/></Col>
          <Col><Sld label="Max. Tiefe (0=unbegrenzt)" min={0} max={20} step={1} value={cfg.surrDepth||0} onChange={v=>set({...cfg,surrDepth:v})} help="Alternative Komplexitätsbegrenzung. 0 = Standard: LightGBM unbegrenzt, CatBoost Tiefe 16 (Maximum) — Begrenzung dann über Blätter/Min-Samples."/></Col>
        </Row>
      </>}
    </Sec>
