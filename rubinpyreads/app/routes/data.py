...
def detect_columns():
    ...
    if os.path.isabs(filepath):
        ...
        # is_relative_to (statt str.startswith) — wie in der Upload-Route:
        # startswith ließe Geschwister-Verzeichnisse mit gleichem Namens-Präfix
        # (z.B. <root>_backup) passieren.
