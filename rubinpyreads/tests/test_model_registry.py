...
from rubin.model_registry import ModelContext, default_registry
...
class TestModelRegistry:
    def test_default_registry_contains_all_models(self):
        ...
        names = reg.list()
        expected = ["CausalForest", "CausalForestDML", "DRLearner", "NonParamDML", "ParamDML",
    ...
    def test_create_drlearner_has_cv_and_random_state(self):
        ...
        _cv = getattr(model, "cv", None)
        assert getattr(_cv, "n_splits", _cv) == 5
