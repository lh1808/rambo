...
const TuningPlanPreview = ({models, trials, cv, outerCv, innerCv: innerCvProp, isBoth, isRct}) => {
  ...
  // Wird in die Fits des jeweiligen Pseudo-Effekt-Tasks eingerechnet, damit die Summe der
  // "Fits"-Spalte exakt der Headline (Base-Learner-Fits) entspricht.
  const pseudoNuisanceOnce = (sig) => sig.split("__")[0]==="pseudo_effect" ? (fullCv * 2 + 2) : 0;
