...
const LGBM_LOGO=`data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 160"><polygon points="0,0 100,0 0,65" fill="%23E44A2C"/><polygon points="100,60 100,100 48,80" fill="%2371B74A"/><polygon points="0,80 0,115 48,97" fill="%232F9FD1"/><polygon points="0,160 100,95 100,160" fill="%23F3AE19"/></svg>')}`;
...
export default function App() {
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",fontFamily:"'DM Sans',system-ui,-apple-system,sans-serif",fontSize:15,color:"#24292f",background:"#faf7f8"}}>
      <nav style={{width:300,minWidth:300,background:"linear-gradient(180deg,#4a080f 0%,#6B0D15 30%,#8a0f1a 100%)",color:"#fff",position:"sticky",top:0,height:"100vh",overflowY:"auto",flexShrink:0,display:"flex",flexDirection:"column",boxShadow:"4px 0 24px rgba(107,13,21,0.15)"}}>
