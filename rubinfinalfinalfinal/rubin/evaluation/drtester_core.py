...
from rubin.utils.plot_theme import (
    apply_rubin_theme, RUBIN_COLORS,
)
apply_rubin_theme()
...
passen (gleiche Reihenfolge/Länge)."""
    ...
    def fit_nuisance(
        ...
        Überschreibt die EconML-Methode (Signatur-Parität mit der Basisklasse).
        Die Train-Argumente setzen nur das fit_on_train-Flag und werden NICHT
        für eine eigene Train-Nuisance-Berechnung verwendet (siehe unten)."""
        ...
        # Train-Cross-Predictions gesetzt), nicht dr_train_. Eine
        # Train-Nuisance-Berechnung wäre daher toter Code — und würde im
        # External-/TMES-Modus crashen, weil der vorberechnete T×Y-Splitter mit
