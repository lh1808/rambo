...
def tune_causal_forest(
    ...
    def objective(trial):
        ...
        # Äußere CV-Folds (tuning_cv_seed) für Score-Bewertung
        # Stratifizierung auf T×Y (wie BLT/FMT) für balancierte Gruppen
        # Bei single_fold=True: nur 1. Fold evaluieren (wie BLT _cv_splits)
        ...
        for fold_i, (tr, va) in enumerate(split_iter):
            ...
            try:
                if is_cfdml:
                    ...
                    # n_jobs=1: Forest-interne Parallelität deaktivieren
                    # (verhindert joblib-Deadlocks bei EconML + CatBoost/LGBM)
                    est = CausalForestDML(
