...
class ReportCollector:
    ...
    def add_config(self, cfg) -> None:
        ...
        self.config_summary = {
            ...
            "dml_crossfit_folds": getattr(cfg.data_processing, "dml_crossfit_folds", 2),
            "tuning_cv_splits": getattr(cfg.tuning, "cv_splits", 2),
            ...
            "final_tuning_cv_splits": getattr(cfg.final_model_tuning, "cv_splits", 2),
            "final_tuning_stability_penalty": getattr(cfg.final_model_tuning, "stability_penalty", 0.3),
...
def generate_html_report(collector: ReportCollector, output_path: str) -> str:
    ...
    if cs.get("tuning_enabled") and collector.tuning_scores:
        ...
        cv = 1 if sf else cs.get("tuning_cv_splits", 2)
    ...
    if cs.get("final_tuning_enabled"):
        ...
        fmt_internal_cv = cs.get("final_tuning_cv_splits", 2)
        fmt_outer_cv = cs.get("cv_splits", 5)
        fmt_sp = cs.get("final_tuning_stability_penalty", 0.3)
