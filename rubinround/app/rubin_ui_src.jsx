...
const LGBM={n_estimators:{min:50,max:1000,step:50,type:"int",dLow:200,dHigh:600},learning_rate:{min:0.001,max:0.3,step:0.005,type:"float",log:true,dLow:0.01,dHigh:0.15},num_leaves:{min:7,max:255,step:1,type:"int",dLow:15,dHigh:127},max_depth:{min:2,max:12,step:1,type:"int",dLow:3,dHigh:8},min_child_samples:{min:5,max:500,step:5,type:"int",dLow:10,dHigh:200},min_child_weight:{min:0.001,max:100,step:0.5,type:"float",dLow:0.01,dHigh:50},subsample:{min:0.3,max:1,step:0.05,type:"float",dLow:0.5,dHigh:1},colsample_bytree:{min:0.1,max:1,step:0.05,type:"float",dLow:0.3,dHigh:0.9},min_split_gain:{min:0,max:3,step:0.05,type:"float",dLow:0,dHigh:1},reg_alpha:{min:0.0000001,max:50,step:0.1,type:"float",dLow:0.000001,dHigh:20},reg_lambda:{min:0.0000001,max:50,step:0.1,type:"float",dLow:0.000001,dHigh:20},max_bin:{min:7,max:255,step:1,type:"int",dLow:15,dHigh:127},path_smooth:{min:0,max:20,step:0.5,type:"float",dLow:0,dHigh:10}};
const CB={iterations:{min:50,max:1000,step:50,type:"int",dLow:200,dHigh:600},learning_rate:{min:0.001,max:0.3,step:0.005,type:"float",log:true,dLow:0.01,dHigh:0.15},depth:{min:2,max:12,step:1,type:"int",dLow:4,dHigh:8},l2_leaf_reg:{min:0.1,max:80,step:0.5,type:"float",dLow:1,dHigh:30},random_strength:{min:0.001,max:20,step:0.1,type:"float",dLow:0.01,dHigh:10},subsample:{min:0.3,max:1,step:0.05,type:"float",dLow:0.5,dHigh:1},rsm:{min:0.1,max:1,step:0.05,type:"float",dLow:0.3,dHigh:0.9},min_data_in_leaf:{min:5,max:500,step:5,type:"int",dLow:10,dHigh:200},model_size_reg:{min:0,max:20,step:0.5,type:"float",dLow:0,dHigh:10},leaf_estimation_iterations:{min:1,max:15,step:1,type:"int",dLow:1,dHigh:10}};
const LGBM_FMT={n_estimators:{min:50,max:800,step:10,type:"int",dLow:100,dHigh:400},learning_rate:{min:0.001,max:0.2,step:0.005,type:"float",log:true,dLow:0.005,dHigh:0.12},num_leaves:{min:3,max:127,step:1,type:"int",dLow:7,dHigh:63},max_depth:{min:1,max:10,step:1,type:"int",dLow:2,dHigh:6},min_child_samples:{min:5,max:1000,step:5,type:"int",dLow:20,dHigh:500},min_child_weight:{min:0.1,max:150,step:0.5,type:"float",dLow:0.5,dHigh:80},subsample:{min:0.2,max:1,step:0.05,type:"float",dLow:0.4,dHigh:0.85},colsample_bytree:{min:0.1,max:1,step:0.05,type:"float",dLow:0.25,dHigh:0.7},max_bin:{min:7,max:255,step:1,type:"int",dLow:15,dHigh:127},min_split_gain:{min:0,max:5,step:0.1,type:"float",dLow:0,dHigh:3},reg_alpha:{min:0.01,max:100,step:0.5,type:"float",dLow:0.1,dHigh:50},reg_lambda:{min:0.1,max:200,step:1,type:"float",dLow:1,dHigh:100},path_smooth:{min:0,max:50,step:1,type:"float",dLow:0,dHigh:30}};
const CB_FMT={iterations:{min:50,max:800,step:10,type:"int",dLow:100,dHigh:400},learning_rate:{min:0.001,max:0.2,step:0.005,type:"float",log:true,dLow:0.005,dHigh:0.12},depth:{min:1,max:10,step:1,type:"int",dLow:2,dHigh:6},l2_leaf_reg:{min:0.5,max:150,step:1,type:"float",dLow:3,dHigh:80},random_strength:{min:0.1,max:30,step:0.5,type:"float",dLow:0.5,dHigh:15},subsample:{min:0.2,max:1,step:0.05,type:"float",dLow:0.4,dHigh:0.85},rsm:{min:0.1,max:1,step:0.05,type:"float",dLow:0.25,dHigh:0.7},min_data_in_leaf:{min:5,max:1000,step:5,type:"int",dLow:20,dHigh:500},model_size_reg:{min:0,max:50,step:0.5,type:"float",dLow:0.1,dHigh:30},leaf_estimation_iterations:{min:1,max:10,step:1,type:"int",dLow:1,dHigh:5}};
...
const CF_SS = {
  n_estimators:         {min:100, max:500, step:4,   type:"int"},
  max_depth:            {min:2,   max:30,  step:1,   type:"int"},
  min_samples_leaf:     {min:5,   max:500, step:5,   type:"int"},
  min_samples_split:    {min:10,  max:1000,step:10,  type:"int"},
  max_features:         {min:0.05,max:1.0, step:0.05,type:"float"},
  max_samples:          {min:0.1, max:0.5, step:0.05,type:"float"},
  min_var_fraction_leaf:{min:0.000001,max:0.1,step:0.0001,type:"float"},
