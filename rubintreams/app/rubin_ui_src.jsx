...
const ADDON_PRESETS = [
  ...
  {key:"fmt_schnell",label:"Schnell",desc:"3 Wellen",group:"tuning_fmt",
    cfg:{fmtEnabled:true,fmtModels:["NonParamDML","DRLearner"]},waves:{field:"fmtTrials",w:3,stage:"fmt"}},
  {key:"fmt",label:"Standard",desc:"5 Wellen",group:"tuning_fmt",
    cfg:{fmtEnabled:true,fmtModels:["NonParamDML","DRLearner"]},waves:{field:"fmtTrials",w:5,stage:"fmt"}},
  {key:"fmt_intensiv",label:"Intensiv",desc:"8 Wellen",group:"tuning_fmt",
    cfg:{fmtEnabled:true,fmtModels:["NonParamDML","DRLearner"]},waves:{field:"fmtTrials",w:8,stage:"fmt"}},
