...
feature_selection:
  ...
  max_features: 60                               # Maximale Anzahl Features nach Selektion
...
- `max_features`: Maximale Anzahl Features nach Selektion (Default: 60). Bei mehreren Methoden wird das Budget gleichmäßig aufgeteilt: jede Methode liefert ceil(max_features / n_methods) Features. Die Union wird auf max_features gekappt (Rank-Aggregation als Tiebreaker).
